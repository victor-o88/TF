 ...
 * @author Alejandrux
 */
public class NivelPosGradoModificar extends javax.swing.JFrame {
        ...
        public void buscar() throws DataAccessException {
            ...
            if (num_reg.getText().isEmpty()) {
                ...
                if (nivelbuscado == null) {
                    ...
                    nilvePg.setSelectedItem(nivelbuscado.getNivel_posgrado());
        ...
        public void modificar() throws DataAccessException {
            if (titulo.getText().isEmpty() || facultad.getText().isEmpty() || provincia.getText().isEmpty() || ciudad.getText().isEmpty()
                ...
                if (aprobacion_tesis > Integer.parseInt(tesis.getText())) {
                    ...
                    String nivelposgrado = (String) nilvePg.getSelectedItem();//NIVEL POSGRADO
                    ...
                    posgrado.setAprobacion_tesis(Integer.parseInt(tesis.getText()));
                    ...
                    if (si.isSelected() == true) {
                        ...
                        posgrado.setObtencion(Integer.parseInt(obtencion.getText()));
                    ...
                    gestor.actualizar(posgrado, Integer.parseInt(num_reg.getText()), id_usuario);
    ...
    private void initComponents() {
        ...
        nilvePg = new javax.swing.JComboBox();
        ...
        jLabel2.setText("Modificar PosGrado");
        ...
        jLabel16.setText("Nivel Univeristario de Posgrado");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 180, -1, -1));

        nilvePg.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Doctorado", "Maestria", "Especializacion" }));
        getContentPane().add(nilvePg, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 200, 120, -1));
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        try {
            ...
            Logger.getLogger(NivelPosGradoModificar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NivelPosGradoModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NivelPosGradoModificar().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox nilvePg;
