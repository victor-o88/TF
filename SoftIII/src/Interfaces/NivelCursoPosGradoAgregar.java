 ...
 * @author Alejandrux
 */
public class NivelCursoPosGradoAgregar extends javax.swing.JFrame {
     ...
     */
    public NivelCursoPosGradoAgregar() {
        initComponents();
        ...
        this.setVisible(true);
               ...
               public void agregar() throws DataAccessException {
                   ...
                   if (curso.getText().isEmpty() || facultad.getText().isEmpty() || provincia.getText().isEmpty() || ciudad.getText().isEmpty()
                       ...
                       if (aprobacion_tesis == 0) {
                       ...
                       } else if (aprobacion_tesis > Integer.parseInt(anio.getText())) {
                           ...
                           if (si.isSelected() == true) {
                               ...
                               cursop.setObtencion(Integer.parseInt(anioObt.getText()));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Agregar Curso de PosGrado");
        ...
        getContentPane().add(curso, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 200, -1));
        ...
        jLabel5.setText("Año de Cursado");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 310, -1, -1));
        getContentPane().add(anio, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 330, 80, -1));
        ...
        jLabel10.setText("Año de Obtención");
        ...
        getContentPane().add(cargaHs, new org.netbeans.lib.awtextra.AbsoluteConstraints(446, 380, 70, -1));
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        try {
            ...
            Logger.getLogger(NivelCursoPosGradoAgregar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NivelCursoPosGradoAgregar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NivelCursoPosGradoAgregar().setVisible(true);
            }
        });
    }
