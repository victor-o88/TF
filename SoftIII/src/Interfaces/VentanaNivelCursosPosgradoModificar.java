...
public class VentanaNivelCursosPosgradoModificar extends JFrame {
    ...
    public VentanaNivelCursosPosgradoModificar() {
        ...
        jl5.setBounds(140, 300, 170, 30);
        jl6.setBounds(350, 300, 140, 30);
        jl14.setBounds(100, 340, 100, 30);
        jl15.setBounds(350, 340, 100, 30);
        ...
        curso.setBounds(200, 180, 180, 30);
        año.setBounds(200, 300, 140, 30);
        ...
        horas.setBounds(200, 340, 140, 30);
    ...
    class ManejadorEventos implements ActionListener {
        ...
        public void buscar() throws DataAccessException {
            ...
            if (registro.getText().isEmpty()) {
                ...
                año.setText(Integer.toString(nivelbuscado.getAnio()));
                horas.setText(Integer.toString(nivelbuscado.getCarga_horaria()));
        ...
        public void modificar() throws DataAccessException {
            ...
            if (curso.getText().isEmpty() || facultad.getText().isEmpty() || provincia.getText().isEmpty() || ciudad.getText().isEmpty()
                ...
                if (aprobacion_tesis > Integer.parseInt(año.getText())) {
                    ...
                    gestor.actualizar(cursop, Integer.parseInt(registro.getText()), id_usuario);
