 ...
 * @author Alejandrux
 */
public class NivelGradoEliminar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Eliminar Grado");
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        try {
            ...
            Logger.getLogger(NivelGradoEliminar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NivelGradoEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NivelGradoEliminar().setVisible(true);
            }
        });
    }
