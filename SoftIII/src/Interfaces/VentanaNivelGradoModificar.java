...
public class VentanaNivelGradoModificar extends JFrame {
    ...
    public VentanaNivelGradoModificar() {
    ...
    class ManejadorEventos implements ActionListener {
        ...
        public void modificar() throws DataAccessException {
            if (titulo.getText().isEmpty() || facultad.getText().isEmpty() || tesis.getText().isEmpty() || provincia.getText().isEmpty() || ciudad.getText().isEmpty()
                ...
                gestor.actualizar(nivel, Integer.parseInt(registro.getText()), id_usuario);
