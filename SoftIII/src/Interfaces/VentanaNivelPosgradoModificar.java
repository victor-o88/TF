...
public class VentanaNivelPosgradoModificar extends JFrame {

    ActionListener manejadorEventos = new ManejadorEventos();
    public String id_usuario;
    JButton bcancelar = new JButton("Cancelar");
    JButton bguardar = new JButton("Modificar y Guardar");
    JButton bbuscar = new JButton("Buscar");
    JLabel jl1 = new JLabel("Nivel de Posgrado");
    JLabel jltitulo = new JLabel("Ingrese Numero de Registro que desea modificar");
    ...
    public VentanaNivelPosgradoModificar() {
        ...
        rbtn1.setBounds(200, 540, 50, 30);
        add(rbtn1);
        grupo1.add(rbtn1);
        rbtn2 = new JRadioButton("No");
        rbtn2.setBounds(250, 540, 50, 30);
        add(rbtn2);
        grupo1.add(rbtn2);

        combo1 = new JComboBox();   //UNIVERSIDADES
        combo1.setBounds(200, 260, 250, 30);
        add(combo1);
        ...
        combo2.setBounds(200, 380, 140, 30);
        add(combo2);
        ...
        combo3.setBounds(200, 500, 250, 30);
        add(combo3);
        ...
        combo4.setBounds(200, 180, 140, 30);
        add(combo4);
        ...
        bguardar.setBounds(330, 630, 150, 30);
        bbuscar.setBounds(220, 630, 100, 30);
        ...
        jl2.setBounds(10, 180, 200, 30);
        jl14.setBounds(135, 220, 100, 30);
        jl3.setBounds(110, 260, 140, 30);
        jl4.setBounds(120, 300, 140, 30);
        jl5.setBounds(20, 340, 170, 30);
        jl6.setBounds(350, 340, 140, 30);
        jl7.setBounds(140, 380, 200, 30);
        jl8.setBounds(120, 420, 140, 30);
        jl9.setBounds(130, 460, 140, 30);
        jl10.setBounds(45, 500, 140, 30);
        jl11.setBounds(25, 540, 170, 30);
        jl12.setBounds(80, 580, 140, 30);
        jl13.setBounds(350, 580, 100, 30);

        año.setBounds(200, 340, 140, 30);
        ciudad.setBounds(200, 460, 140, 30);
        añoObt.setBounds(200, 580, 140, 30);
        provincia.setBounds(200, 420, 140, 30);
        facultad.setBounds(200, 300, 140, 30);
        titulo.setBounds(200, 220, 140, 30);
    ...
    class ManejadorEventos implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == bcancelar) {
                ...
                try {
                    ...
                    Logger.getLogger(VentanaNivelPosgradoModificar.class.getName()).log(Level.SEVERE, null, ex);
                }
        ...
        public void buscar() throws DataAccessException {
            ...
            if (registro.getText().isEmpty()) {
                ...
                if (nivelbuscado == null) {
                    ...
                    combo4.setSelectedItem(nivelbuscado.getNivel_posgrado());
                    ...
                    año.setText(Integer.toString(nivelbuscado.getAprobacion_tesis()));
                    ...
                    añoObt.setText(Integer.toString(nivelbuscado.getObtencion()));
                }
            }
        }
        ...
        public void modificar() throws DataAccessException {
            if (titulo.getText().isEmpty() || facultad.getText().isEmpty() || provincia.getText().isEmpty() || ciudad.getText().isEmpty()
                ...
                if (aprobacion_tesis > Integer.parseInt(año.getText())) {
                    ...
                    gestor.actualizar(posgrado, Integer.parseInt(registro.getText()), id_usuario);
                    JOptionPane.showMessageDialog(null, "  Datos Nivel Posgrado modificado con exito  ");
                    dispose();
                }
            }
        }
